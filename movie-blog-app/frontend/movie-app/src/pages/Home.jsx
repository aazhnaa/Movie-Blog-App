...
const Home = () => {
  ...
  return (
    <> 
      ...
      {(isLogin)?
        <div className='flex flex-col justify-center items-center text-center text-2xl font-bold text-blue-950 '>
        ...
        <div className="card-container grid-cols-2 grid-rows-1">
